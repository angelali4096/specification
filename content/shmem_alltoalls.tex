...
\apidescription{
    ...
    Given a \ac{PE} \VAR{i} that is the \VARTH{k} PE in the active set and a \ac{PE}
    \VAR{j} that is the \VARTH{l} \ac{PE} in the active set,
    \ac{PE} \VAR{i} sends the \VAR{sst}*\VARTH{l} block of the \VAR{source} data object to
    the \VAR{dst}*\VARTH{k} block of the \VAR{dest} data object on
    \ac{PE} \VAR{j}.
