...
\apidescription{
    ...
    Given a \ac{PE} \VAR{i} that is the \kth PE in the \activeset{} and a \ac{PE}
    \VAR{j} that is the \lth \ac{PE} in the \activeset{},
...
\apinotes{
    ...
    The implementor must ensure the that the \VAR{pSync} array is not being updated by any
