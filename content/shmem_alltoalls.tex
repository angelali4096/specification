\apisummary{
    shmem\_alltoalls is a collective routine where each \ac{PE} exchanges a fixed amount of strided data with all other \acp{PE} in the \activeset.
}
...
\apidescription{
    ...
    \VAR{j} that is the \VAR{l}th \ac{PE} in the active set,
    \ac{PE} \VAR{i} sends the \VAR{sst}*\VAR{l}th block of the \VAR{source} data object to
