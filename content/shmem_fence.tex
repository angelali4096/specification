\apisummary{
    Assures ordering of delivery of \PUT{}, \acp{AMO}, and memory store routines to symmetric data objects.
}
...
\apinotes{
    ...
    There is a subtle difference between \FUNC{shmem\_fence} and \FUNC{shmem\_quiet}, in that, \FUNC{shmem\_quiet} guarantees completion of \PUT{}, \acp{AMO}, and memory store routines to
